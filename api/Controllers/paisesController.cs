...
namespace api.Controllers
{
    public class paisesController : ApiController
    {
        public string getForCombobox()
        {
            ...
            string query = "SELECT id, nombre as nombre from cf_paises where estado=1 order by nombre;";
        ...
        public string Post(int id, [FromBody]Object value)
        {
            ...
            string update_query = string.Format("UPDATE `cf_paises` " +
             "set " +
            "nombre = '{0}' " +
            ", direccion  = '{1}' " +
            ", email = '{2}' " +
        ...
        public string Post([FromBody]Object value)
        {
            try
            {
                ...
                //Actualizamos los datos con un update query. 
                string insert_query = string.Format("INSERT INTO `cf_paises` " +
                "(`nombre`," +
                    "`direccion`," +
                    "`email`) " +
                "VALUES " +
