...
namespace api.Controllers
{
    public class unidadesController : ApiController
    {
        public string getCombobox()
        {
            ...
            string query = "SELECT id, nombre from lu_unidades where estado=1 order by nombre;";
        ...
        public string Post(int id, [FromBody]Object value)
        {
            ...
            string update_query = string.Format("UPDATE `lu_unidades` " +
             "set " +
            "nombre = '{0}' " +
            "where id='{1}' "
        ...
        public string Post([FromBody]Object value)
        {
            try
            {
                ...
                //Actualizamos los datos con un update query. 
                string insert_query = string.Format("INSERT INTO `lu_unidades` " +
                "(`nombre`) " +
                "VALUES " +
                "('{0}');"
                    , json["nombre"].ToString().Replace("'", "''"));
